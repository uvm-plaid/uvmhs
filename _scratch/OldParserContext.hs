...
--   }
-- instance Eq ParserContextDocCached where (==) = (≡) `on` (ppRenderWide ∘ execParserContextDoc ∘ parserContextDocCachedDoc) -- (≡) `on` parserContextDocCachedBytes
-- instance Ord ParserContextDocCached where compare = (⋚) `on` (ppRenderWide ∘ execParserContextDoc ∘ parserContextDocCachedDoc) -- parserContextDocCachedBytes
