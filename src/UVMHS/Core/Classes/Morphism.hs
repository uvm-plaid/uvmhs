...
instance Symmetric Iso where sym (Iso to from) = Iso from to
instance Symmetric Iso2 where sym (Iso2 to from) = Iso2 from to
instance Symmetric Iso3 where sym (Iso3 to from) = Iso3 from to
