...
𝔱 "subst:fvs" [| fvs [ulc| 0                   |] |] [| (↦) () $ pow $ map DVar [0]             |]
𝔱 "subst:fvs" [| fvs [ulc| 0 1                 |] |] [| (↦) () $ pow $ map DVar [0,1]           |]
𝔱 "subst:fvs" [| fvs [ulc| λ x → 0 1           |] |] [| (↦) () $ pow $ map DVar [0]             |]
𝔱 "subst:fvs" [| fvs [ulc| λ x → (λ y → 2) 0   |] |] [| (↦) () $ pow $ map DVar [0]             |]
𝔱 "subst:fvs" [| fvs [ulc| λ x → (λ y → 1) 1   |] |] [| (↦) () $ pow $ map DVar [0]             |]
𝔱 "subst:fvs" [| fvs [ulc| λ x → (λ y → 2) 1   |] |] [| (↦) () $ pow $ map DVar [0]             |]
𝔱 "subst:fvs" [| fvs [ulc| x                   |] |] [| (↦) () $ pow $ map (nvar∘var) ["x"]     |]
𝔱 "subst:fvs" [| fvs [ulc| x y                 |] |] [| (↦) () $ pow $ map (nvar∘var) ["x","y"] |]
𝔱 "subst:fvs" [| fvs [ulc| λ x → y             |] |] [| (↦) () $ pow $ map (nvar∘var) ["y"]     |]
